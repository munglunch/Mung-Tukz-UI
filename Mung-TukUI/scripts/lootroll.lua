...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(TukuiDB["media"].uffont, 10, "OUTLINE")
...
local function CreateRollFrame()
	...
	bind:SetFont(TukuiDB["media"].uffont, 10, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(TukuiDB["media"].uffont, 10, "OUTLINE")
...
label:SetFont(TukuiDB["media"].uffont, 10, "OUTLINE")
...
anchor:SetScript("OnEvent", function(frame, event, addon)
	...
	anchor:SetPoint("TOP", UIParent, "TOP", 0, TukuiDB:Scale(-300))
end)
