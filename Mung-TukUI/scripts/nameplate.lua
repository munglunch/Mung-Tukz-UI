...
if g + b == 0 then
-- Hostile unit
newr, newg, newb = 0.99, 0.11, 0.11
self.healthBar:SetStatusBarColor(0.99, 0.11, 0.11)
elseif r + b == 0 then
-- Friendly unit
newr, newg, newb = 0.13, 0.79, 0.13
self.healthBar:SetStatusBarColor(0.13, 0.79, 0.13)
elseif r + g == 0 then
-- Friendly player
...
-- Neutral unit
newr, newg, newb = 0.85, 0.83, 0.05
self.healthBar:SetStatusBarColor(0.85, 0.83, 0.05)
else
...
newNameRegion:SetTextColor(0.84, 0.75, 0.65, 0)
